...
// machine-specific absolute path is baked into rendering code.
...
var (
	// AssetRoot resolved from repository layout; never a cross-worktree absolute path.
	AssetRoot = func() string {
		c := filepath.Join(ggRepoRoot(), "assets")
