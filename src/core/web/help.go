...
func Help(r *gin.Engine) {
	r.GET("/help", func(c *gin.Context) {
		...
		publicCmds = append(publicCmds, Cmd{Cmd: "/ap", Desc: "开启理智提醒", Param: "on", IsBind: true})
		publicCmds = append(publicCmds, Cmd{Cmd: "/ap", Desc: "关闭理智提醒", Param: "off", IsBind: true})
		publicCmds = append(publicCmds, Cmd{Cmd: "/ap", Desc: "设理智提醒阈值", Param: "thr [1-100]", IsBind: true})
		...
		publicCmds = append(publicCmds, Cmd{Cmd: "/skin", Desc: "干员皮肤查询", Param: "", IsBind: false})
		...
		adminCmds = append(adminCmds, Cmd{Cmd: "/quiz", Desc: "开启云玩家检测", Param: "on", IsBind: false})
		adminCmds = append(adminCmds, Cmd{Cmd: "/quiz", Desc: "关闭云玩家检测", Param: "off", IsBind: false})
		adminCmds = append(adminCmds, Cmd{Cmd: "/headhunt", Desc: "开启寻访模拟", Param: "on", IsBind: false})
		adminCmds = append(adminCmds, Cmd{Cmd: "/headhunt", Desc: "关闭寻访模拟", Param: "off", IsBind: false})
